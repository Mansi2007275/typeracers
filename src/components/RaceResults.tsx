...
export default function RaceResults({
  ...
  const rewardAmount = correctWords * scorePerWord;
  ...
  return (
    <div className="reward-overlay">
      ...
      <div className="reward-amount">{rewardAmount.toFixed(1)} SOM SCORE</div>
      <div className="reward-subtitle">
        {correctWords} correct words x {scorePerWord} multiplier
      </div>
